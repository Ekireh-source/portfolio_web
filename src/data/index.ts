...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a Blockchain based Repository with plagiarism detection",
...
export const projects = [
  ...
  {
    id: 2,
    title: "Energy sharing for Umeme",
    des: "Have the ability to transfer your units from one meter to another and buy units through our web based app",
    img: "/p2.svg",
