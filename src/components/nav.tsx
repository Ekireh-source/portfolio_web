    ...
    >
      ...
      <div className="hidden md:block">
        <Menu
          setActive={setActive}
          className={cn(
            "glass-card shadow-lg shadow-cyan-500/5",
            scrolled && mounted && "shadow-blue-500/10",
          )}
        >
          {navItems.map((item) => (
      ...
      <div className="md:hidden">
        <button
          ...
          className="relative z-50 flex h-11 w-11 items-center justify-center rounded-full glass-card shadow-lg shadow-cyan-500/5 hover:shadow-blue-500/10 transition-all duration-300"
          ...
          {mobileMenuOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-0 left-0 z-40 h-full w-64 glass-card"
              >
